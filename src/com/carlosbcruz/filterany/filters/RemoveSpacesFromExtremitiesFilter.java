...
/**
 * Remove all spaces from the extremities of the line.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveSpacesFromExtremitiesFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMEXTREMITIES_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMEXTREMITIES_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMEXTREMITIES_INSTRUCTIONS);
	}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVESPACESFROMEXTREMITIES_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVESPACESFROMEXTREMITIES_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMEXTREMITIES_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMEXTREMITIES_REPORT,
