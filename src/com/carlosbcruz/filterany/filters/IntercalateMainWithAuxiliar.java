 ...
 */
public class IntercalateMainWithAuxiliar extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text
				.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_FIELD_1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_FIELD_1_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		String stepInput = getField1();

		int step = 1;

		if (!"".equals(stepInput.trim())) { //$NON-NLS-1$
			try {
				step = Integer.parseInt(stepInput);
			} catch (NumberFormatException e) {
				ExceptionSupport
						.handleException(Text
								.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_EXCEPTION_1));
			...
			if (step <= 0) {
				ExceptionSupport
						.handleException(Text
								.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_EXCEPTION_2));
				return new StringBuffer();
			}
		}
		...
		do {
			...
			if (mainHasLine && auxiliarHasLine) {
				output.append(mainLine + auxiliarLine + getNewLine());
				this.linesCombined++;
			}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_COMMAND_LINE_HELP);
	}
	...
	public String getAuxiliarInputExample() {
		...
		return Text
				.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_EXAMPLE_AUXILIAR_INPUT);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_INTERCALATEMAINWITHAUXILIAR_REPORT,
