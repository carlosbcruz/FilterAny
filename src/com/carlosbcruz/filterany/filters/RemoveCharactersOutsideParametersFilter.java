...
/**
 * Remove all contents outside parameteres.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveCharactersOutsideParametersFilter extends FilterAdapter
	...
	public String getFilterName() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_INPUT_1),
				Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_INPUT_2),
				Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_CHECKBOX_1),
				Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_CHECKBOX_2) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_INPUT_1_TOOLTIP),
				Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_INPUT_2_TOOLTIP),
				Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_CHECKBOX_1_TOOLTIP),
				Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_CHECKBOX_2_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		if (parameterFrom == null || "".equals(parameterFrom)) { //$NON-NLS-1$
			throw new FilterException(
					Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_REQUIRED_PARAMETER1));
		}

		if (parameterTo == null || "".equals(parameterTo)) { //$NON-NLS-1$
			throw new FilterException(
					Text.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_REQUIRED_PARAMETER2));
		}
		...
		if (spans.isEmpty()) {
			...
			for (Span span : spans) {
				...
				if (includeParameters) {
					outputBuffer.append(input.substring(span.getStart(),
							span.getEnd() + parameterTo.length()));
				} else {
					outputBuffer.append(input.substring(span.getStart()
							+ parameterFrom.length(), span.getEnd()));
				}
				outputBuffer.append(getNewLine());
			}
		}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(
				Text.FILTER_REMOVECHARACTERSOUTSIDEPARAMETERSFILTER_REPORT,
