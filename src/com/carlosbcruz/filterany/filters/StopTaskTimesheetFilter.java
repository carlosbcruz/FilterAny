...
/**
 * Add an entry to stop a task on a timesheet.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class StopTaskTimesheetFilter extends TimesheetAbstractFilter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_STOPTASKTIMESHEETFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_STOPTASKTIMESHEETFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_STOPTASKTIMESHEETFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text
				.get(Text.FILTER_STOPTASKTIMESHEETFILTER_FIELD_1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_STOPTASKTIMESHEETFILTER_FIELD_1_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		output.append("Stop," + getDayOfTheWeek() + " " //$NON-NLS-1$ //$NON-NLS-2$
				+ getCurrentDateAndTime() + "," + getField1()); //$NON-NLS-1$
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_STOPTASKTIMESHEETFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_STOPTASKTIMESHEETFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_STOPTASKTIMESHEETFILTER_EXAMPLE_OUTPUT);
	}
