...
/**
 * Maintain the lines that are on a regular steps of lines.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class MaintainLinesAtRegularStepFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text
				.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_FIELD1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_FIELD1_TOOLTIP) };
	}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text
				.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_MAINTAINLINESATREGULARSTEPFILTER_REPORT,
				String.valueOf(this.linesPreserved));
	}
