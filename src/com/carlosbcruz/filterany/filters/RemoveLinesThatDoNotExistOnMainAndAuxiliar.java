...
/**
 * Remove the lines that do not exist on both main and auxiliar panels.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveLinesThatDoNotExistOnMainAndAuxiliar extends FilterAdapter
	...
	public String getFilterName() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_CHECKBOX_1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_CHECKBOX_1_TOOLTIP) };
	}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_COMMAND_LINE_HELP);
	}
	...
	public String getAuxiliarInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_EXAMPLE_AUXILIAR_INPUT);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(
				Text.FILTER_REMOVELINESTHATDONOTEXISTONMAINANDAUXILIAR_REPORT,
