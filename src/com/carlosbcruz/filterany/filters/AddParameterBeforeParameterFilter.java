 ...
 */
public class AddParameterBeforeParameterFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_FIELD1),
				Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_FIELD2),
				Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_CHECKBOX1),
				Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_FIELD3) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_FIELD2_TOOLTIP),
				Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_CHECKBOX1_TOOLTIP),
				Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_FIELD3_TOOLTIP), };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		if (parameter == null || "".equals(parameter)) { //$NON-NLS-1$
			throw new FilterException(
					Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_EXCEPTION));
		}
		...
		if (!"".equals(orderParameter)) { //$NON-NLS-1$
			...
			try {
				...
				throw new FilterException(Text.get(
						Text.FILTER_ADDPARAMETERBEFOREPARAMETER_EXCEPTION2,
						orderParameter));
			}
			if (order <= 0) {
				throw new FilterException(Text.get(
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (index >= 0) {
				...
				currentLine = currentLine.substring(0, index) + getField1()
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_ADDPARAMETERBEFOREPARAMETER_REPORT,
