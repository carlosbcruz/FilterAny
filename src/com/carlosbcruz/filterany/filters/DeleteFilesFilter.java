 ...
 */
public class DeleteFilesFilter extends FilterAdapter implements CommandLine,
		RenameFile, Example, BinaryFilesFilter, SpecialBehavior {
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_DELETEFILEFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_DELETEFILEFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_DELETEFILEFILTER_INSTRUCTIONS);
	}
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_DELETEFILEFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getNewFileName(String fileName) throws FilterException {
		...
		// Return null to delete the file.
		return null;
	}
		...
		if (sourceFile.isFile()) {
			...
			if (!sourceFile.delete()) {
				...
				throw new FilterException(
						Text.get(
								Text.FILTER_DELETEFILEFILTER_FILE_PROBLEM_DELETING_A_FILE,
			...
			throw new FilterException(Text.get(
					Text.FILTER_DELETEFILEFILTER_IT_IS_NOT_A_FILE, fileFrom));
		}

		// This return is ignored.
		return new String();
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_DELETEFILEFILTER_EXAMPLE_MAIN_INPUT);
	}
