...
/**
 * Add an anchor to the end of all lines.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class AddAnchorOnEndOfLineFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_ADDANCHORONENDOFLINE_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_ADDANCHORONENDOFLINE_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_ADDANCHORONENDOFLINE_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_ADDANCHORONENDOFLINE_FIELD1),
				Text.get(Text.FILTER_ADDANCHORONENDOFLINE_FIELD2) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_ADDANCHORONENDOFLINE_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_ADDANCHORONENDOFLINE_FIELD2_TOOLTIP) };
	}
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (currentStep == step) {
				...
				if (tokenizer.isFoundNewLine()) {
					...
					output.append(token + getField1() + getNewLine());
				} else {

					output.append(token + getField1());
				}
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_ADDANCHORONENDOFLINE_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_ADDANCHORONENDOFLINE_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_ADDANCHORONENDOFLINE_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_ADDANCHORONENDOFLINE_REPORT,
