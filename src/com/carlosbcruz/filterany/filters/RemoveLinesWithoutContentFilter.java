...
/**
 * Remove all lines that do not have the provided content in it.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveLinesWithoutContentFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_FIELD1),
				Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_CHECKBOX1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_CHECKBOX1_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		if ("".equals(getField1())) { //$NON-NLS-1$
			throw new FilterException(
					Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_EXCEPTION));
		}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_REMOVELINESWITHOUTCONTENT_REPORT,
