...
/**
 * Add an anchor to the beginning of all lines.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class AddAnchorOnBeginOfLineFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_FIELD1),
				Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_FIELD2) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_FIELD2_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		try {
			step = Integer.parseInt(getField2());
		...
		if ("".equals(getField1())) { //$NON-NLS-1$
			throw new FilterException(
					Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_EXCEPTION));
		}
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (currentStep == step) {
				...
				if (tokenizer.isFoundNewLine()) {
					output.append(getField1() + token + getNewLine());
				} else {
					output.append(getField1() + token);
				}
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_ADDANCHORONBEGINOFLINE_REPORT,
