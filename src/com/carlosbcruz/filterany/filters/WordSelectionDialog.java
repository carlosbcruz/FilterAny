 ...
 */
public class WordSelectionDialog extends FreeSelectionDialog {
	 ...
	 */
	public WordSelectionDialog(String title, StringBuffer contentParameter,
	...
	FreeSelectionCanvas getCanvas(StringBuffer contentParameter) {
		...
		return new WordSelectionCanvas(contentParameter);
	}
