 ...
 */
public class RemoveLinesThatExistOnMainAndAuxiliar extends FilterAdapter
	...
	public String getFilterName() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_CHECKBOX_1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_CHECKBOX_1_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		while (mainTokenizer.hasMoreTokens()) {
			...
			if (isCheckBox1()) {
				if (auxiliarLines.contains(token.trim())) {
					this.linesRemoved++;
					continue;
				}
			} else {
				if (auxiliarLines.contains(token.trim().toUpperCase())) {
					this.linesRemoved++;
					continue;
				}
			}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_COMMAND_LINE_HELP);
	}
	...
	public String getAuxiliarInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_EXAMPLE_AUXILIAR_INPUT);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(
				Text.FILTER_REMOVELINESTHATEXISTONMAINANDAUXILIAR_REPORT,
