...
/**
 * Allows the free movement of characters.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class CharacterMoveFilter extends FilterAdapter implements Example,
		SpecialBehavior {
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_CHARACTER_MOVE_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_CHARACTER_MOVE_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_CHARACTER_MOVE_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		if ("".equals(text.toString().trim())) { //$NON-NLS-1$
			JOptionPane.showMessageDialog(getSuperComponent(),
					Text.get(Text.FILTER_CHARACTER_MOVE_NO_CONTENT_MESSAGE),
					Text.get(Text.FILTER_CHARACTER_MOVE_NO_CONTENT_TITLE),
					JOptionPane.OK_OPTION);
			return new StringBuffer();
		}

		CharacterMoveDialog dialog = new CharacterMoveDialog(
				Text.get(Text.FILTER_CHARACTER_MOVE_TITLE),
				StringSupport.setLintesToSameLength(text));
		...
		for (ArrayList<SelectedElement> line : dialog.getLines()) {
			...
			for (SelectedElement element : line) {
				...
				currentLine.append(element.getText());
			}

			output.append(StringSupport.trimRight(currentLine.toString())
					+ getNewLine());
		}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_CHARACTER_MOVE_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_CHARACTER_MOVE_EXAMPLE_OUTPUT);
	}
