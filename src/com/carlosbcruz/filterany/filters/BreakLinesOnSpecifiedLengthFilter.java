...
/**
 * Break lines on a specific width.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class BreakLinesOnSpecifiedLengthFilter extends FilterAdapter implements
		CommandLine, SpecialBehavior, Example, Report {

	private static final long serialVersionUID = 1L;

	private final static int DEFAULT_LENGTH = 80;

	private int linesBroken = 0;
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_FIELD1),
				Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_CHECKBOX1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_CHECKBOX1_TOOLTIP) };
	}
	 ...
	 */
	@Override
	public boolean includeNonSelectedText() {
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		// Retrieve the length.
		String lengthParameter = getField1().trim();
		if ("".equals(lengthParameter)) { //$NON-NLS-1$
			...
			try {
				...
				throw new FilterException(Text.get(
						Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_EXCEPTION,
						lengthParameter));
			}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_BREAKLINESONSPECIFIEDLENGTH_REPORT,
				String.valueOf(this.linesBroken));
	}
