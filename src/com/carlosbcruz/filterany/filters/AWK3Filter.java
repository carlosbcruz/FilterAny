 ...
 */
public class AWK3Filter extends FilterAdapter implements CommandLine,
		SpecialBehavior, Example {

	private static final long serialVersionUID = 1L;

	private static final String INPUT_FILE = "AWK3in.txt"; //$NON-NLS-1$
	private static final String OUTPUT_FILE = "AWK3out.txt"; //$NON-NLS-1$
	private static final String OUTPUT_FINISHED_FLAG_FILE = "AWKScript3.awk.ok"; //$NON-NLS-1$
	private static final String SCRIPT_FILE = "AWKScript3.awk"; //$NON-NLS-1$
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_AWK3FILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_AWK3FILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_AWK3FILTER_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		try {
			...
			throw new FilterException(Text.get(
					Text.FILTER_AWK3FILTER_EXCEPTION1, exception.getMessage()));
		}
		...
		do {
			try {
				...
				throw new FilterException(Text.get(
						Text.FILTER_AWK3FILTER_EXCEPTION1,
		...
		if (timeout >= TIMEOUT) {
			...
			throw new FilterException(
					Text.get(Text.FILTER_AWK3FILTER_EXCEPTION2));
		}
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_AWK3FILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_AWK3FILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_AWK3FILTER_EXAMPLE_OUTPUT);
	}
