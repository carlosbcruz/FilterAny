...
/**
 * If there are duplicated lines than leave only the first line occurrence.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveDuplicatedLinesFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_CHECKBOX1),
				Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_CHECKBOX2) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_CHECKBOX1_TOOLTIP),
				Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_CHECKBOX2_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (isCheckBox2()) {
				...
				verificationToken = token = tokenizer.nextToken();
			}
			...
			// Only add the token if it is not a repetition
			if (!texts.contains(verificationToken)) {

				texts.put(new Integer(verificationToken.hashCode()),
						verificationToken);
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_REMOVEDUPLICATEDLINES_REPORT,
