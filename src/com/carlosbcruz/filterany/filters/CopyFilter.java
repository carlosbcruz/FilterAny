...
/**
 * Copy the content with no change.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class CopyFilter extends FilterAdapter implements CommandLine,
		SpecialBehavior, Example, Report {

	private static final long serialVersionUID = 1L;

	private int charactersCopied = 0;
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_COPYFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_COPYFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_COPYFILTER_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		this.charactersCopied = text.length();
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_COPYFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_COPYFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_COPYFILTER_EXAMPLE_OUTPU);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_COPYFILTER_REPORT,
				String.valueOf(this.charactersCopied));
	}
}
