...
/**
 * Generate a time series for a timesheet.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class TimesheetTimeSeriesChartFilter extends TimesheetAbstractFilter
		implements Example, SpecialBehavior {
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_TIMESHEETTIMESERIESCHARTFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_TIMESHEETTIMESERIESCHARTFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_TIMESHEETTIMESERIESCHARTFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text
				.get(Text.FILTER_TIMESHEETTIMESERIESCHARTFILTER_CHECK_BOX_1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_TIMESHEETTIMESERIESCHARTFILTER_CHECK_BOX_1_TOOLTIP) };
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_TIMESHEETTIMESERIESCHARTFILTER_EXAMPLE_MAIN_INPUT);
	}
