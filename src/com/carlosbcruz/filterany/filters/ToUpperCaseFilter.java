 ...
 */
public class ToUpperCaseFilter extends FilterAdapter implements CommandLine,
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_TOUPPERCASEFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_TOUPPERCASEFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_TOUPPERCASEFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text.get(Text.FILTER_TOUPPERCASEFILTER_FIELD_1),
				Text.get(Text.FILTER_TOUPPERCASEFILTER_FIELD_2) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_TOUPPERCASEFILTER_FIELD_1_TOOLTIP),
				Text.get(Text.FILTER_TOUPPERCASEFILTER_FIELD_2_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		if (!"".equals(position1Text)) { //$NON-NLS-1$
			...
			try {
				...
				throw new FilterException(Text.get(
						Text.FILTER_TOUPPERCASEFILTER_EXCEPTION_1,
						position1Text));
			}

			if (position1 < 0) {
				throw new FilterException(Text.get(
						Text.FILTER_TOUPPERCASEFILTER_EXCEPTION_1_1,
						position1Text));
			}
		}
		...
		if (!"".equals(position2Text)) { //$NON-NLS-1$
			...
			try {
				...
				throw new FilterException(Text.get(
						Text.FILTER_TOUPPERCASEFILTER_EXCEPTION_2,
						position2Text));
			}

			if (position2 < 1) {
				throw new FilterException(Text.get(
						Text.FILTER_TOUPPERCASEFILTER_EXCEPTION_2_1,
						position2Text));
			}
		}
		...
		if (position1 != NOT_DEFINED && position2 != NOT_DEFINED) {
			...
			if (position1 >= position2) {
				...
				throw new FilterException(
						Text.get(Text.FILTER_TOUPPERCASEFILTER_EXCEPTION_3));
			}
		}
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (position1 == NOT_DEFINED && position2 == NOT_DEFINED) {
				...
				if (tokenizer.isFoundNewLine()) {
					String converted = token.toUpperCase();
				...
				if (position1 >= 0 && position2 == NOT_DEFINED) {
					...
					if (token.length() > position1) {
						...
						if (tokenizer.isFoundNewLine()) {
							String converted = part2.toUpperCase();
							this.charactersReplaced += StringSupport
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_TOUPPERCASEFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_TOUPPERCASEFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_TOUPPERCASEFILTER_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_TOUPPERCASEFILTER_REPORT,
