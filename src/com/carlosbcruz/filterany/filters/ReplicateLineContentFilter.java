...
/**
 * Duplicate the lines a certain number of times.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class ReplicateLineContentFilter extends FilterAdapter implements
	...
	private int linesReplicated = 0, numberOfReplications = 0;
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_REPLICATELINECONTENT_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_REPLICATELINECONTENT_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_REPLICATELINECONTENT_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_REPLICATELINECONTENT_FIELD1),
				Text.get(Text.FILTER_REPLICATELINECONTENT_FIELD2) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_REPLICATELINECONTENT_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_REPLICATELINECONTENT_FIELD2_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		this.linesReplicated = this.numberOfReplications = 0;

		StringBuffer output = new StringBuffer();

		int repetitions = NOT_DEFINED;

		String repetitionsText = getField1().trim();

		if ("".equals(repetitionsText)) { //$NON-NLS-1$
			repetitions = 1;
		} else {
			try {
				...
				throw new FilterException(
						Text.get(Text.FILTER_REPLICATELINECONTENT_EXCEPTION1));
			}
		}

		String separation = " "; //$NON-NLS-1$
		if (!"".equals(getField2())) { //$NON-NLS-1$
			separation = getField2();
		}

		LineTokenizer tokenizer = new LineTokenizer(text);

		this.numberOfReplications = repetitions;

		while (tokenizer.hasMoreTokens()) {

			String token = tokenizer.nextToken();

			this.linesReplicated++;
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_REPLICATELINECONTENT_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_REPLICATELINECONTENT_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_REPLICATELINECONTENT_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_REPLICATELINECONTENT_REPORT,
				String.valueOf(this.linesReplicated),
				String.valueOf(this.numberOfReplications));
	}
