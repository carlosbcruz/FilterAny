...
/**
 * Format a JSON if it is valid.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class JSONFormatterFilter extends FilterAdapter implements CommandLine,
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_JSONFORMATTERFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_JSONFORMATTERFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_JSONFORMATTERFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text.get(Text.FILTER_JSONFORMATTERFILTER_FIELD1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_JSONFORMATTERFILTER_FIELD1_TOOLTIP) };
	}
	...
	public static String prettyFormat(String input, int numberOfSpacesToIndent) {
		...
		return Text.get(Text.FILTER_JSONFORMATTERFILTER_EXCEPTION, errorMessage);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		output.append(prettyFormat(text.toString(), numberOfSpaces));
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_JSONFORMATTERFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_JSONFORMATTERFILTER_EXAMPLE_OUTPUT);
	}
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_JSONFORMATTERFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getReportText() {
		...
		return "".equals(errorMessage) ? Text //$NON-NLS-1$
				.get(Text.FILTER_JSONFORMATTERFILTER_REPORT_OK) : Text
				.get(Text.FILTER_JSONFORMATTERFILTER_REPORT_ERROR);
	}
}
