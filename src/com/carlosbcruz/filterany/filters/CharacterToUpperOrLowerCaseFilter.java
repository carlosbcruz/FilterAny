...
/**
 * Transform the characters of a specific column to upper or lowercase.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class CharacterToUpperOrLowerCaseFilter extends FilterAdapter implements
		CommandLine, SpecialBehavior, Example, Report {

	private static final long serialVersionUID = 1L;

	private int charactersConverted = 0;
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_CHECKBOX1),
				Text.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_INPUTFIELD1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_CHECKBOX1_TOOLTIP),
				Text.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_INPUTFIELD1_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		this.charactersConverted = 0;

		int column = 0;

		try {
			column = Integer.parseInt(getField1());
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (column < token.length()) {
				...
				if (column > 0) {
					before = token.substring(0, column);
				}
				String after = new String();
				if (column + 1 < token.length()) {
					after = token.substring(column + 1);
				}
				char character = token.charAt(column);

				if (isCheckBox1()) {
					output.append(before + Character.toUpperCase(character)
							+ after + getNewLine());
				} else {
					output.append(before + Character.toLowerCase(character)
							+ after + getNewLine());
				}
			} else {
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_CHARACTERTOUPPERORLOWERCASEFILTER_REPORT,
				String.valueOf(this.charactersConverted));
	}
}
