 ...
 */
public class StartTaskTimesheetFilter extends TimesheetAbstractFilter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_STARTTASKTIMESHEETFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_STARTTASKTIMESHEETFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_STARTTASKTIMESHEETFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text
				.get(Text.FILTER_STARTTASKTIMESHEETFILTER_FIELD_1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_STARTTASKTIMESHEETFILTER_FIELD_1_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		output.append("Start," + getDayOfTheWeek() + " " //$NON-NLS-1$ //$NON-NLS-2$
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_STARTTASKTIMESHEETFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_STARTTASKTIMESHEETFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_STARTTASKTIMESHEETFILTER_EXAMPLE_OUTPUT);
	}
