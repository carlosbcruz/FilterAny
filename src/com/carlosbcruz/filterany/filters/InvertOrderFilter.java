...
/**
 * Invert the sequence of the lines in a text.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class InvertOrderFilter extends FilterAdapter implements CommandLine,
		SpecialBehavior, Example, Report {

	private static final long serialVersionUID = 1L;

	private int linesInverted = 0;
	...
	public String getFilterName() {
		...
		return Text
				.get(Text.FILTER_INVERTORDERFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text
				.get(Text.FILTER_INVERTORDERFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_INVERTORDERFILTER_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		while (linesTokenizer.hasMoreTokens()) {
			...
			lines.add(linesTokenizer.nextToken());
		}

		// Generate the final text.
		for (int i = lines.size() - 1; i >= 0; i--) {
			output.append(lines.get(i) + getNewLine());
			this.linesInverted++;
		}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_INVERTORDERFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_INVERTORDERFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text
				.get(Text.FILTER_INVERTORDERFILTER_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(
				Text.FILTER_INVERTORDERFILTER_REPORT,
				String.valueOf(this.linesInverted));
	}
