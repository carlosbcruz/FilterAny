 ...
 */
public class WordSelectionToTableDialog extends FreeSelectionDialog {
	 ...
	 */
	public WordSelectionToTableDialog(String title,
	...
	FreeSelectionCanvas getCanvas(StringBuffer contentParameter) {
		...
		return new WordSelectionToTableCanvas(contentParameter);
	}
