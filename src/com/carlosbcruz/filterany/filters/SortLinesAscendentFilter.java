...
/**
 * Sort the lines in an ascendent order.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class SortLinesAscendentFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_CHECKBOX1),
				Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_CHECKBOX2) };
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_CHECKBOX1_TOOLTIP),
				Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_CHECKBOX2_TOOLTIP) };
	}
		...
		for (int i = 0; i < lines.size(); i++) {
			...
			try {
				...
				ExceptionSupport.handleException(Text
						.get(Text.FILTER_SORTLINESASCENDENTFILTER_EXCEPTION1));
			}
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_SORTLINESASCENDENTFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_SORTLINESASCENDENTFILTER_REPORT,
