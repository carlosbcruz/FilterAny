...
/**
 * Remove the lines that not not have any parameter that exist on auxiliar
 * panels.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveLinesWithoutMultipleParameters extends FilterAdapter
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text
				.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_CHECKBOX_1) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] { Text
				.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_CHECKBOX_1_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		while (mainTokenizer.hasMoreTokens()) {
			...
			if (!isCheckBox1()) {
				searchToken = token.toUpperCase();
			}

			boolean exist = false;
			for (String auxiliarToken : auxiliarLines) {

				if (searchToken.indexOf(auxiliarToken) >= 0) {
					exist = true;
					break;
				}
			}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_COMMAND_LINE_HELP);
	}
	...
	public String getAuxiliarInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_EXAMPLE_AUXILIAR_INPUT);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(
				Text.FILTER_REMOVELINESWITHOUTMULTIPLEPARAMETERS_REPORT,
