...
/**
 * Add an anchor to a position on all lines.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class AddAnchorOnAPositionFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_ADDANCHORONAPOSITION_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_ADDANCHORONAPOSITION_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_ADDANCHORONAPOSITION_INSTRUCTIONS);
	}
	...
	public FilterType[] getControlsType() {
		...
		return new FilterType[] { FilterType.ANYTHING,
				FilterType.NUMBER_POSITION, FilterType.NUMBER_GENERIC };
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_ADDANCHORONAPOSITION_FIELD1),
				Text.get(Text.FILTER_ADDANCHORONAPOSITION_FIELD2),
				Text.get(Text.FILTER_ADDANCHORONAPOSITION_FIELD3) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_ADDANCHORONAPOSITION_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_ADDANCHORONAPOSITION_FIELD2_TOOLTIP),
				Text.get(Text.FILTER_ADDANCHORONAPOSITION_FIELD3_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		try {
			step = Integer.parseInt(getField3());
		...
		if ("".equals(getField1())) { //$NON-NLS-1$
			throw new FilterException(
					Text.get(Text.FILTER_ADDANCHORONAPOSITION_EXCEPTION_2));
		}

		String positionText = getField2().trim();
		int position = 0;
		...
		try {
			...
			throw new FilterException(Text.get(
					Text.FILTER_ADDANCHORONAPOSITION_EXCEPTION, positionText));
		}
		if (position < 0) {
			throw new FilterException(Text.get(
					Text.FILTER_ADDANCHORONAPOSITION_EXCEPTION, positionText));
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (currentStep == step) {
				...
				if (position >= token.length()) {
					...
					for (int i = token.length(); i < position; i++) {
						token += " "; //$NON-NLS-1$
					}
					token += getField1();
					...
					token = token.substring(0, position) + getField1()
							+ token.substring(position);
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_ADDANCHORONAPOSITION_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_ADDANCHORONAPOSITION_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_ADDANCHORONAPOSITION_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_ADDANCHORONAPOSITION_REPORT,
