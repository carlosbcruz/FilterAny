...
/**
 * Allows the free selection of characters.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class CharacterSelectionFilter extends FilterAdapter implements Example,
		SpecialBehavior {
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_CHARACTER_SELECTION_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_CHARACTER_SELECTION_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_CHARACTER_SELECTION_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		if ("".equals(text.toString().trim())) { //$NON-NLS-1$
			JOptionPane.showMessageDialog(getSuperComponent(),
					Text.get(Text.FILTER_WORD_SELECTION_NO_CONTENT_MESSAGE),
					Text.get(Text.FILTER_WORD_SELECTION_NO_CONTENT_TITLE),
					JOptionPane.OK_OPTION);
			return new StringBuffer();
		}

		CharacterSelectionDialog dialog = new CharacterSelectionDialog(
				Text.get(Text.FILTER_CHARACTER_SELECTION_TITLE), text, false);
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_CHARACTER_SELECTION_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_CHARACTER_SELECTION_EXAMPLE_OUTPUT);
	}
