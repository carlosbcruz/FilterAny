 ...
 */
public class AWK1Filter extends FilterAdapter implements CommandLine,
		SpecialBehavior, Example {

	private static final long serialVersionUID = 1L;

	private static final String INPUT_FILE = "AWK1in.txt"; //$NON-NLS-1$
	private static final String OUTPUT_FILE = "AWK1out.txt"; //$NON-NLS-1$
	private static final String OUTPUT_FINISHED_FLAG_FILE = "AWKScript1.awk.ok"; //$NON-NLS-1$
	private static final String SCRIPT_FILE = "AWKScript1.awk"; //$NON-NLS-1$
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_AWK1FILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_AWK1FILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_AWK1FILTER_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		try {
			...
			throw new FilterException(Text.get(
					Text.FILTER_AWK1FILTER_EXCEPTION1, exception.getMessage()));
		}
		...
		do {
			try {
				...
				throw new FilterException(Text.get(
						Text.FILTER_AWK1FILTER_EXCEPTION1,
		...
		if (timeout >= TIMEOUT) {
			...
			throw new FilterException(
					Text.get(Text.FILTER_AWK1FILTER_EXCEPTION2));
		}
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_AWK1FILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_AWK1FILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_AWK1FILTER_EXAMPLE_OUTPUT);
	}
