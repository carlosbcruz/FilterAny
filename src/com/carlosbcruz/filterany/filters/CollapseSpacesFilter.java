 ...
 */
public class CollapseSpacesFilter extends FilterAdapter implements CommandLine,
		SpecialBehavior, Example, Report {

	private static final long serialVersionUID = 1L;

	private int numbersOfConsecutiveSpacesFound = 0;
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_COLLAPSESPACES_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_COLLAPSESPACES_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_COLLAPSESPACES_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] { Text.get(Text.FILTER_COLLAPSESPACES_FIELD_1),
				Text.get(Text.FILTER_COLLAPSESPACES_FIELD_2) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_COLLAPSESPACES_FIELD_1_TOOLTIP),
				Text.get(Text.FILTER_COLLAPSESPACES_FIELD_2_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		this.numbersOfConsecutiveSpacesFound = 0;
		...
		while (tokenizer.hasMoreTokens()) {
			...
			for (int i = 0; i < token.length(); i++) {
				...
				if (thisCharacter == ' ') {
					...
					if (isInsideSpace) {
						if (numberOfSpacesFound >= numberOfSpaces) {
							output.append(parameter);
							this.numbersOfConsecutiveSpacesFound++;
						} else {
							for (int j = 0; j < numberOfSpacesFound; j++) {
								output.append(' ');
							}
						}
						isInsideSpace = false;
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_COLLAPSESPACES_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_COLLAPSESPACES_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_COLLAPSESPACES_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_COLLAPSESPACES_REPORT,
				String.valueOf(this.numbersOfConsecutiveSpacesFound));
	}
}
