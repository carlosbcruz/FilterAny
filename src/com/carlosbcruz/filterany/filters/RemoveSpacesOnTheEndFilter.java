...
/**
 * Remove all spaces on the end of the line.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveSpacesOnTheEndFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_REMOVESPACESONTHEEND_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_REMOVESPACESONTHEEND_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_REMOVESPACESONTHEEND_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		while (tokenizer.hasMoreTokens()) {
			...
			token = StringSupport.trimRight(token);
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_REMOVESPACESONTHEEND_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_REMOVESPACESONTHEEND_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_REMOVESPACESONTHEEND_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_REMOVESPACESONTHEEND_REPORT,
