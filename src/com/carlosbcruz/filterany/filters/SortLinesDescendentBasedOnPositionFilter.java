...
/**
 * Sort the lines in an descendent order based on a position.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class SortLinesDescendentBasedOnPositionFilter extends FilterAdapter
	...
	public String getFilterName() {
		...
		return Text
				.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text
				.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text
				.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_FIELD1),
				Text.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_CHECKBOX1) };
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_CHECKBOX1_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		try {
			...
			throw new FilterException(
					Text.get(
							Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_EXCEPTION2,
							positionText));
		}
			...
			try {
				...
				ExceptionSupport
						.handleException(Text
								.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_EXCEPTION1));
			}
		...
		// Invert the order.
		String inverteDOrderLines[] = new String[lineNumber];
		for (int i = 0; i < lineNumber; i++) {
			inverteDOrderLines[i] = orderedLines[lineNumber - 1 - i];
		}

		// Generate the final text.
		for (int i = 0; i < lineNumber; i++) {
			output.append(inverteDOrderLines[i] + getNewLine());
			this.linesSorted++;
		}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text
				.get(Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(
				Text.FILTER_SORTLINESDESCENDENTBASEDONPOSITIONFILTER_REPORT,
