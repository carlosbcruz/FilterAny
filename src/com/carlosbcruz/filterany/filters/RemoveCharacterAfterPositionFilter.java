...
/**
 * Remove all characters after a specific position on the line.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveCharacterAfterPositionFilter extends FilterAdapter implements
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_INSTRUCTIONS);
	}
	...
	public String[] getControlsLabels() {
		...
		return new String[] {
				Text.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_FIELD1),
				Text.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_FIELD2) };
	}
	...
	public String[] getControlsToolTipTexts() {
		...
		return new String[] {
				Text.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_FIELD1_TOOLTIP),
				Text.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_FIELD2_TOOLTIP) };
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText)
		...
		try {
			...
			throw new FilterException(Text.get(
					Text.FILTER_REMOVECHARACTERSAFTERPOSITION_EXCEPTION,
					positionText));
		}
		...
		if ("".equals(numberOfCharactersParameter)) { //$NON-NLS-1$
			...
			try {
				...
				throw new FilterException(Text.get(
						Text.FILTER_REMOVECHARACTERSAFTERPOSITION_EXCEPTION2,
		...
		while (tokenizer.hasMoreTokens()) {
			...
			int end = position + numberOfCharacters;
			...
			if (position <= token.length()) {
				token = token.substring(0, position)
						+ token.substring(end, token.length());
			}
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_REMOVECHARACTERSAFTERPOSITION_REPORT,
