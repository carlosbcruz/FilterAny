...
/**
 * Remove all spaces on beginning of the line.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class RemoveSpacesOnBeginningFilter extends FilterAdapter implements
		CommandLine, SpecialBehavior, Example, Report {

	private static final long serialVersionUID = 1L;

	private int spacesRemoved = 0;
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMBEGINNING_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMBEGINNING_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMBEGINNING_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		while (tokenizer.hasMoreTokens()) {
			...
			token = StringSupport.trimLeft(token);

			this.spacesRemoved += previousLength - token.length();
	...
	public String getHelpDescription() {
		...
		return Text
				.get(Text.FILTER_REMOVESPACESFROMBEGINNING_COMMAND_LINE_HELP);
	}
	...
	public String getMainInputExample() {
		...
		return Text
				.get(Text.FILTER_REMOVESPACESFROMBEGINNING_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMBEGINNING_EXAMPLE_OUTPUT);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_REMOVESPACESFROMBEGINNING_REPORT,
				String.valueOf(this.spacesRemoved));
	}
}
