...
/**
 * Transform all new lines to unix format.
 * 
 * @author Carlos Fernando Bella Cruz - <a
 *         href="mailto:pessoal@carlosbcruz.com">pessoal@carlosbcruz.com</a>
 */
public class ToUNIXFilter extends FilterAdapter implements CommandLine,
	...
	public String getFilterName() {
		...
		return Text.get(Text.FILTER_TOUNIXFILTER_LABEL);
	}
	...
	public String getSmallDescription() {
		...
		return Text.get(Text.FILTER_TOUNIXFILTER_TOOLTIP);
	}
	...
	public String getFilterInstructions() {
		...
		return Text.get(Text.FILTER_TOUNIXFILTER_INSTRUCTIONS);
	}
	...
	protected StringBuffer filter(StringBuffer text, StringBuffer auxiliarText) {
		...
		while (tokenizer.hasMoreTokens()) {
			...
			if (tokenizer.isFoundNewLine()) {
				output.append(token + StringSupport.getUnixNewLine());
				this.linesConverted++;
			} else {
				output.append(token);
			}
	...
	public String getMainInputExample() {
		...
		return Text.get(Text.FILTER_TOUNIXFILTER_EXAMPLE_MAIN_INPUT);
	}
	...
	public String getOutputExample() {
		...
		return Text.get(Text.FILTER_TOUNIXFILTER_FILTER_TOUNIXFILTER);
	}
	...
	public String getHelpDescription() {
		...
		return Text.get(Text.FILTER_TOUNIXFILTER_COMMAND_LINE_HELP);
	}
	...
	public String getReportText() {
		...
		return Text.get(Text.FILTER_TOUNIXFILTER_REPORT,
				String.valueOf(this.linesConverted));
	}
}
